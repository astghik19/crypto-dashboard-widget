...
const Drawer: FC<PropsWithChildren<IProps>> = ({children, placement = "left", onClose, title}) => {
  ...
  return createPortal(
    <>
      ...
      <div
        className={`fixed top-0 h-screen w-full bg-white max-w-lg transition-all shadow-input p-6 z-50 ${placement}-0`}
